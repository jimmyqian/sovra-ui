<template>
  ...
  >
    ...
    >
      <!-- Close Button -->
      <button
        class="absolute top-4 right-4 z-10 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-brand-orange-dark bg-white rounded-full p-2 shadow-md"
