<template>
  <div class="space-y-6">
      ...
      <button
        ...
        :class="
          category.active
            ...
            : 'bg-bg-card text-text-secondary border-border-light hover:border-brand-orange hover:text-brand-orange-dark'
        "
    ...
    <div class="text-center">
      <button
        class="px-6 py-2 rounded-full border border-brand-orange text-brand-orange-dark text-sm transition-colors hover:bg-brand-orange hover:text-white"
