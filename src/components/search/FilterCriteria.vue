<template>
  <div class="flex flex-wrap gap-2">
    ...
    <button
      class="text-brand-orange-dark border-brand-orange bg-transparent border px-3 py-1 rounded-tag text-sm cursor-pointer transition-all duration-200 hover:bg-brand-orange hover:text-bg-card"
