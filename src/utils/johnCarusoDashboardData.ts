...
export const getJohnCarusoProfile = () => {
  return {
    name: 'John Caruso',
    profileImage:
    ...
    social: {
      instagram: '@johncaruso',
      followers: '3,200+ followers',
      activity: 'Highly active, narcissistic posts'
    },
    family: {
      father: 'John Cole Caruso Jr. (Oil & Gas Executive)',
      mother: 'Victoria Caruso (Philanthropist)',
      uncle: 'Judge Harrison Caruso (Texas Supreme Court)',
      connections: 'VP Office political ties'
    }
  }
}

export const getJohnCarusoLifeEvents = (): TimelineEvent[] => {
  return [
    {
      year: 2002,
      label: 'Born Dallas',
      category: 'personal',
      description: 'Born into prominent Caruso family in Dallas, TX'
    },
    {
      year: 2016,
...
export const getJohnCarusoLocations = (): USLocation[] => {
  return [
    {
      city: 'Dallas',
      state: 'TX',
...
export const getJohnCarusoTrackingSources = () => {
  return [
    {
      name: 'Instagram',
    ...
    {
      name: 'Family Network',
      description: 'Caruso family connections, political ties',
      count: 89,
...
// John's network - showing gambling connections and family ties
export const getJohnCarusoNetwork = () => {
  const nodes = [
    {
      id: 'preston',
      name: 'John Caruso',
...
export const getJohnCarusoGamblingTransactions = () => {
  return [
    {
      date: '2024-01-15',
      amount: -450,
...
export const getJohnCarusoSocialMediaSentiment = () => {
  return [
  ...
  return {
    ...
    keyFindings: [
      ...
      },
      {
        ...
        text: 'Caruso family ties to Texas judiciary and VP office amplify any scandal',
    ...
    recommendations: [
      ...
      },
      {
        ...
        description:
          "John's gambling debts ($50k+ estimated) create coercion vulnerability. Implement family financial firewalls to prevent any Schmidt assets from becoming entangled.",
        actions: [
      ...
      },
      {
        ...
        description:
          "Prepare for potential public fallout if John's gambling and volatile behavior becomes public. His political family connections amplify any scandal.",
        actions: [
          'PR crisis plan',
          'Media monitoring',
          'Legal distancing',
      ...
      },
      {
        ...
        description:
          'Gambling debts create blackmail and coercion risks. John may attempt to leverage Schmidt family resources or connections to pay debts.',
        actions: [
          'Background check Caruso family',
    ...
    nextSteps: [
      'Activate SOVRA Continuous Monitoring on John Caruso for real-time gambling and behavioral tracking',
      ...
      'Enable SOVRA Reputation Shield to monitor and suppress any emerging scandal involving Caruso family',
