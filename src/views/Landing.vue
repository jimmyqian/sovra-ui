  ...
  <div class="landing">
    <div class="container">
      ...
      <div class="content">
        ...
        <h2 class="question">What do you <strong>want to know</strong> today?</h2>
        <p class="tip">Try adding more detail: works better when you give more context or share your goal</p>
