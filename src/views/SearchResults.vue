          ...
          <div class="search-content">
            ...
            <div class="ai-response">
              ...
              <div class="response-content">
                <p>
                  <strong>Fantastic!</strong> 56 persons were found in the
                  results. Please provide additional information about the
                  person you're looking for.
                </p>
                <p>
                  Alternatively, you can use the hints below for finding the
                  person you're looking for.
                </p>

                <div class="suggestions">
                  <p class="suggestion-item">
                    What specific software role does Johnson hold in his
                    California
                  </p>
                  <p class="suggestion-item">
                    Which California tech hubs are most likely where Johnson
                    works
                  </p>
                  <p class="suggestion-item">
                ...
                <p>
                  Or include further information, such as any documents you may
                  have about him, web links, pictures, or videos; if so, submit
                  them by using the upload option.
                </p>
        ...
        <div class="results-header">
          <div class="results-info">
            ...
            <div class="filter-tags">
              ...
              <button class="create-criteria-btn">
